...
plugins=(git brew macports pip python sublime sudo web-search wd extract osx \
         mfunc)

# Set default user to hide user@host when logged in as me on local machine
DEFAULT_USER=user
...
PPOWERLEVEL9K_MODE='awesome-patched'
...
# autoload all functions from $ZSH/functions
